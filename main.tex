...
\begin{figure}[h]
    \centering
    \subfloat[Modal analysis. Modes are sorted at all times.]{\label{fig:cubModesAddInCenter}{ \includegraphics[width=0.45\textwidth]{modesAddPointsInCenter.eps}}}
    \hspace{0.05\textwidth}
    \subfloat[Spectrogram of system wave excited with raised cosine when $N = 15$.]{\label{fig:cubSpecAddCenter}{ \includegraphics[width=0.45\textwidth]{specAddCenter.eps}}}
...
\begin{figure}[h]
    \centering
    \subfloat[Modal analysis. Modes are sorted at all times.]{\label{fig:altCubModesAddInCenter}{ \includegraphics[width=0.45\textwidth]{modalAnalysisFigs/altCubicMid.eps}}}
    \hspace{0.05\textwidth}
    \subfloat[Spectrogram of system wave excited with raised cosine when $N = 15$.]{\label{fig:altCubSpecAddCenter}{ \includegraphics[width=0.45\textwidth]{modalAnalysisFigs/specAltCubicMid.eps}}}
